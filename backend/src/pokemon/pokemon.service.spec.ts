...
describe('PokemonService', () => {
  ...
  describe('addFavorite', () => {
    it('should add a new favorite and return the list', async () => {
      ...
      expect(mockRepository.findOne).toHaveBeenCalledWith({ where: { name: pokemonName } });
  ...
  describe('removeFavorite', () => {
    ...
    it('should throw NotFoundException if favorite does not exist', async () => {
      ...
      await expect(service.removeFavorite(pokemonName)).rejects.toThrow(NotFoundException,);
      await expect(service.removeFavorite(pokemonName)).rejects.toThrow("Favorite 'mew' not found");
    });
  });
});